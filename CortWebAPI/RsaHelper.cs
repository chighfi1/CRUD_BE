...
namespace CortWebAPI
{
    ...
    public class RsaHelper: IRsaHelper
    {
        ...
        public RsaHelper()
        {
            string private_pem = @".\mykey.pem";
            string public_pem = @".\mypublickey.pem";
        ...
        public string Encrypt(string text)
        {
            ...
            var encryptedBytes = _publicKey.Encrypt(Encoding.UTF8.GetBytes(text), false /* platform independant */);
            return Convert.ToBase64String(encryptedBytes);
        }

        public string Decrypt(string encrypted)
        {
            var decryptedBytes = _privateKey.Decrypt(Convert.FromBase64String(encrypted /* returns bytes */), false);
            return Encoding.UTF8.GetString(decryptedBytes, 0, decryptedBytes.Length  /*  extract plain text */);
        }
